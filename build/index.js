...
const resolvers = {
  Query: {
    user: (parent, {
      ...
      return _db__WEBPACK_IMPORTED_MODULE_0__["users"].find(u => u.id == id);
    },
  ...
  Mutation: {
    ...
    updateUser: (parent, {
      ...
      let newUser = _db__WEBPACK_IMPORTED_MODULE_0__["users"].find(u => u.id == id);
    ...
    deleteUser: (parent, {
      ...
      const userIndex = _db__WEBPACK_IMPORTED_MODULE_0__["users"].findIndex(u => u.id == id);
